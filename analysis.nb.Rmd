...
test with remaining regex

```{r}

stop_punctuation <- "[<p>]|[\\,\\.\\:\\;\\*\\@\\'\\\"\\-\\$\\(\\)]|(\\-\\-)|('s)|('d)|('t)|(n't)|('ve)|('re)|('ll)"

# tokens[[2]] %>% str_to_lower() %>% str_subset(stop_punctuation, negate=T)

# tokens <- map(tokens, ~ str_to_lower(str_subset(.x, "[<p>]|[\\,\\.\\:\\;\\*\\@\\'\\\"\\-\\$\\(\\)]|(\\-\\-)|('s)|('d)|('t)|(n't)|('ve)|('re)|('ll)", negate=T)))
