...
news <- news %>% mutate(document_id = sub(document_id, 3,9), text = sub(text, start = 10))
...
cos_list %>% 
  ...
  gather("value", key = "value", value = value) %>% head()

cos_tbl <- tibble(cos_list, cos_sim = cos_list)
