...
# news <- 
  # separate_wider_regex(news, cols = `.`, delim = , too_few = "debug", too_many="debug", cols_remove=T, widths = c(a = 2, document_id = 7)) %>% head()
  # 
  # separate_wider_position(news, cols = `.`, too_few = "debug", too_many = "debug", cols_remove=T, widths = c(document_id = 9)) %>% head()
